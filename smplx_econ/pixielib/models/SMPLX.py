...
class SMPLX(nn.Module):
    ...
    def __init__(self, config):
        ...
        ss = np.load('/scratch/cvlab/home/ren/code/Others/ECON/data/HPS/pixie_data/SMPLX_NEUTRAL_2020.npz', allow_pickle=True)
        ...
        if config.extra_joint_path:
            self.extra_joint_selector = JointsFromVerticesSelector(fname='/scratch/cvlab/home/ren/code/Others/ECON/data/HPS/pixie_data/smplx_extra_joints.yaml')
        self.use_joint_regressor = True
        self.keypoint_names = SMPLX_names
        if self.use_joint_regressor:
            with open('/scratch/cvlab/home/ren/code/Others/ECON/data/HPS/pixie_data/SMPLX_to_J14.pkl', "rb") as f:
